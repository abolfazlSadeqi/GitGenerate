...
// ثبت سرویس‌ها
builder.Services.AddSingleton<IGitConceptService, GitConceptService>();
builder.Services.AddSingleton<IGitIgnoreService, GitIgnoreService>();
builder.Services.AddSingleton<IGitFlowService, GitFlowService>();
builder.Services.AddSingleton<IVersionService, VersionService>();
builder.Services.AddSingleton<IGitResourceService, GitResourceService>();
builder.Services.AddSingleton<IGitTagService, GitTagService>();
builder.Services.AddScoped<IGitSubmoduleService, GitSubmoduleService>();
